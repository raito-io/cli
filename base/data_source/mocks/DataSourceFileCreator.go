...
type mockConstructorTestingTNewDataSourceFileCreator interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDataSourceFileCreator(t mockConstructorTestingTNewDataSourceFileCreator) *DataSourceFileCreator {
