...
func (_m *MockDataSourceSyncer) SyncAccessProvidersFromTarget(ctx context.Context, accessProviderHandler AccessProviderHandler, configMap *config.ConfigMap) error {
	//TODO implement me
	panic("implement me")
}

func (_m *MockDataSourceSyncer) SyncAccessProviderToTarget(ctx context.Context, accessProviders *sync_to_target.AccessProviderImport, accessProviderFeedbackHandler AccessProviderFeedbackHandler, configMap *config.ConfigMap) error {
	//TODO implement me
	panic("implement me")
}
