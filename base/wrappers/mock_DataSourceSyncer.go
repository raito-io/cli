...
func (_m *MockDataSourceSyncer) GetDataSourceMetaData(ctx context.Context) (*data_source.MetaData, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*data_source.MetaData, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *data_source.MetaData); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_e *MockDataSourceSyncer_Expecter) GetDataSourceMetaData(ctx interface{}) *MockDataSourceSyncer_GetDataSourceMetaData_Call {
	return &MockDataSourceSyncer_GetDataSourceMetaData_Call{Call: _e.mock.On("GetDataSourceMetaData", ctx)}
}
