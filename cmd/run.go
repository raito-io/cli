...
func initRunCommand(rootCmd *cobra.Command) {
	...
	cmd.PersistentFlags().String(constants.TagKeyForUserIsMachine, "", "If set, will determine the tag-key used for determine if a user is a machine user when imported in to Raito Cloud.")
	cmd.PersistentFlags().String(constants.TagValueForUserIsMachine, "", "If set, will determine the tag-value used for determine if a user is a machine user when imported in to Raito Cloud.")
	...
	BindFlag(constants.TagKeyForUserIsMachine, cmd)
	BindFlag(constants.TagValueForUserIsMachine, cmd)
