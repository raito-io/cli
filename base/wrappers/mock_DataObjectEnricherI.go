...
type mockConstructorTestingTNewMockDataObjectEnricherI interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDataObjectEnricherI(t mockConstructorTestingTNewMockDataObjectEnricherI) *MockDataObjectEnricherI {
