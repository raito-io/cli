...
func (_m *MockAccessProviderRoleSyncer) SyncAccessProviderMasksToTarget(ctx context.Context, masksToRemove []string, access []*sync_to_target.AccessProvider, feedbackHandler wrappers.AccessProviderFeedbackHandler, configMap *config.ConfigMap) error {
	ret := _m.Called(ctx, masksToRemove, access, feedbackHandler, configMap)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, []*sync_to_target.AccessProvider, wrappers.AccessProviderFeedbackHandler, *config.ConfigMap) error); ok {
		r0 = rf(ctx, masksToRemove, access, feedbackHandler, configMap)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockAccessProviderRoleSyncer_Expecter) SyncAccessProviderMasksToTarget(ctx interface{}, masksToRemove interface{}, access interface{}, feedbackHandler interface{}, configMap interface{}) *MockAccessProviderRoleSyncer_SyncAccessProviderMasksToTarget_Call {
	return &MockAccessProviderRoleSyncer_SyncAccessProviderMasksToTarget_Call{Call: _e.mock.On("SyncAccessProviderMasksToTarget", ctx, masksToRemove, access, feedbackHandler, configMap)}
}

func (_c *MockAccessProviderRoleSyncer_SyncAccessProviderMasksToTarget_Call) Run(run func(ctx context.Context, masksToRemove []string, access []*sync_to_target.AccessProvider, feedbackHandler wrappers.AccessProviderFeedbackHandler, configMap *config.ConfigMap)) *MockAccessProviderRoleSyncer_SyncAccessProviderMasksToTarget_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]string), args[2].([]*sync_to_target.AccessProvider), args[3].(wrappers.AccessProviderFeedbackHandler), args[4].(*config.ConfigMap))
	})
	return _c
}
...
func (_c *MockAccessProviderRoleSyncer_SyncAccessProviderMasksToTarget_Call) RunAndReturn(run func(context.Context, []string, []*sync_to_target.AccessProvider, wrappers.AccessProviderFeedbackHandler, *config.ConfigMap) error) *MockAccessProviderRoleSyncer_SyncAccessProviderMasksToTarget_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *MockAccessProviderRoleSyncer_Expecter) SyncAccessProviderRolesToTarget(ctx interface{}, rolesToRemove interface{}, access interface{}, feedbackHandler interface{}, configMap interface{}) *MockAccessProviderRoleSyncer_SyncAccessProviderRolesToTarget_Call {
	return &MockAccessProviderRoleSyncer_SyncAccessProviderRolesToTarget_Call{Call: _e.mock.On("SyncAccessProviderRolesToTarget", ctx, rolesToRemove, access, feedbackHandler, configMap)}
}
...
func (_c *MockAccessProviderRoleSyncer_SyncAccessProviderRolesToTarget_Call) RunAndReturn(run func(context.Context, []string, map[string]*sync_to_target.AccessProvider, wrappers.AccessProviderFeedbackHandler, *config.ConfigMap) error) *MockAccessProviderRoleSyncer_SyncAccessProviderRolesToTarget_Call {
	_c.Call.Return(run)
	return _c
}
