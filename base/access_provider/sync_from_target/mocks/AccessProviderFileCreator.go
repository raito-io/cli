...
type mockConstructorTestingTNewAccessProviderFileCreator interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAccessProviderFileCreator(t mockConstructorTestingTNewAccessProviderFileCreator) *AccessProviderFileCreator {
