...
func file_identity_store_identity_store_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_identity_store_identity_store_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_identity_store_identity_store_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_identity_store_identity_store_proto_msgTypes[2].Exporter = func(v any, i int) any {
